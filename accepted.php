...
include "db.php";
// $uid=$_GET['uname'];
$sql="SELECT request.pname, request.age,request.hospital,register.uname, register.bgroup, register.email, register.pnumber
FROM request 
INNER JOIN register ON request.rid=register.status where request.uid = ".$user_id;
...
// if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        // echo "<br> id: ". $row["email"]. " - Name: ". . " " . $row["upswd1"] . "<br>";
